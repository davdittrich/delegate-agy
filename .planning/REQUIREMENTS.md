...
|-----|-------|--------------|--------|
| R5 | Phase 3 | `6q1` | partial — 137 discrimination shipped on branch; `v5a` closed (plan 03-01: bridge external-kill, both output forms; plan 03-02: shim external-kill (EC03) and bridge generic-nonzero (EC04) mirrored, EC_KILL9_TAIL pinned across both scripts and README (EC05), exit-137 row restated); README's remaining exit-2/3/124/127 rows, the generic-nonzero divergence note, and the exit-2 consistency pass still pending (plans 03-03, 03-04) |
