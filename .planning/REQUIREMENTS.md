...
|-----|-------|--------------|--------|
| R5 | Phase 3 | `6q1` | partial — 137 discrimination shipped on branch; `v5a` closed (plan 03-01: empty-stderr dangling separator fixed on the bridge, both plain-text and JSON forms, EC01/EC02); docs, the shim's sibling branch, and the remaining exit codes still pending (plans 03-02 through 03-04) |
